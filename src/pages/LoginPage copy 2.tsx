...
import UnitCoreLogo from '../UnitCore.svg'; // <--- ESTA ES LA ÚNICA LÍNEA NUEVA DE IMPORTACIÓN
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            {/* ESTA ES LA SECCIÓN QUE SE MODIFICA */}
            <Link to="/" className="text-3xl font-bold text-[#0A0A0A] tracking-tight">
              {/* AQUÍ ES DONDE LA PALABRA "UnitCore" ES REEMPLAZADA POR LA IMAGEN */}
              <img
                src={UnitCoreLogo}
                alt="Logo de UnitCore"
                className="h-10 w-auto mx-auto" // Clases de Tailwind para el tamaño y centrado
              />
            </Link>
